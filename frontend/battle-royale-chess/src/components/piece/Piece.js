export default function Piece({ type, styling, color, w, h, vB }){
    ...
    const pieces = {
        outlined:{
            King:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "-6 -2 110 110"}>
                    <g
                      fill="none"
                      fillOpacity="0"
                      fillRule="evenodd"
            ...
            Queen:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "38 -4 110 110"}>
                    <g
                      fill="none"
                      fillOpacity="0"
                      fillRule="evenodd"
            ...
            Bishop:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "84 -5 110 110"}>
                    <g
                      fill="none"
                      fillOpacity="0"
                      fillRule="evenodd"
            ...
            Knight:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "129 -5 110 110"}>
                    <g
                      fill="none"
                      fillOpacity="0"
                      fillRule="evenodd"
            ...
            Tower:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "174 -5 110 110"}>
                    <g
                      fill="none"
                      fillOpacity="0"
                      fillRule="evenodd"
            ...
            Pawn:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "218 -5 110 110"}>
                    <g>
                      <path
                        fill="none"
                        fillOpacity="0"
        ...
        filled:{
            King:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "-5 38 110 110"}>
                    <g
                      fill="none"
                      fillRule="evenodd"
                      stroke={color.stroke}
            ...
            Queen:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "40 38 110 110"}>
                    <g
                      fill={color.fill}
                      fillRule="evenodd"
                      stroke={color.stroke}
                      ...
                      strokeWidth="1.5"
                    >
                      <g fill={color.fill} stroke={color.stroke} transform="translate(45 45)">
            ...
            Bishop:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "85 40 110 110"}>
                    <g
                      fill="none"
                      fillRule="evenodd"
                      stroke={color.stroke}
            ...
            Knight:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "131 40 110 110"}>
                    <g
                      fill="none"
                      fillRule="evenodd"
                      stroke={color.stroke}
            ...
            Tower:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "176 39 110 110"}>
                    <g
                      fill={color.fill}
                      fillRule="evenodd"
                      stroke={color.stroke}
            ...
            Pawn:(
                <svg width={w || "200"} height={h || "200"} viewBox={vB || "220 40 110 110"}>
                    <g>
                        <path
                          stroke={color.stroke}
                          fill={color.fill}
